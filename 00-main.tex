...
%%%% COMMON MATH OPERATORS USED THROUGHOUT THE THESIS
...
%%%% SAFE FALLBACKS FOR GENERATED TABLES/FIGURES
\newcommand{\MaybeInput}[1]{%
  \IfFileExists{#1}{%
    \input{#1}%
  }{%
    \begin{center}%
      \fbox{\parbox{0.9\textwidth}{\small Missing generated file: \texttt{#1}. Upload the generated thesis asset or rerun the export pipeline before the final build.}}%
    \end{center}%
  }%
}
\newcommand{\MaybeIncludeGraphics}[2][]{%
  \IfFileExists{\FigurePath/#2}{%
    \includegraphics[#1]{#2}%
  }{%
    \IfFileExists{#2}{%
      \includegraphics[#1]{#2}%
    }{%
      \fbox{\parbox{0.85\textwidth}{\small Missing figure file: \texttt{#2}. Upload the generated figure to Overleaf or regenerate the thesis assets locally.}}%
    }%
  }%
}
...
\setlength{\cftchapnumwidth}{\widthof{\textbf{Chapter~10~}}}
...
\include{13-chapter-6}
%\include{14-endpoint-clustered-simulation}
