...
\ThesisTitle{\LaTeX\ Dissertation Template for Johns Hopkins University Bloomberg School of Public Health}

\vspace{1in}                    % gap between the title and the author: approx. 1 inch

\ThesisAuthor{Moran Guo}         % author name for the thesis
...
\ThesisStatement{dissertation}{ScM in Biostatistics}
%% gap between statement and location: approx. 0.5 inch
\vspace{0.5in} \\               

\Location \\                    % prints Baltimore, Maryland as the location
\ThesisDate{April}{2026}        % thesis submission month and year (single-spaced)
...
\ThesisCopyright{2026}{Moran Guo}
