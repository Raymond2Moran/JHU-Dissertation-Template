...
The applied case study focuses on physical protein--protein interactions, meaning whether two proteins are recorded as interacting in curated benchmark data. I develop a leakage-aware workflow that builds edge-level surrogate scores from protein sequence and UniProt text representations and then carries an ensemble predictor into downstream estimation and planning. The predictive goal is to score candidate interactions. The inferential goal is different: estimate prevalence-like quantities and their uncertainty when only a limited subset of edges is experimentally validated.
