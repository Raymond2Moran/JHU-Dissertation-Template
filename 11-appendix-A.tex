...
The compact Chapter~\ref{chap:protein_results} tables emphasize the main point estimates needed for the narrative. The full interval estimates for the same held-out inference summaries are listed below.

\input{generated_tables/appendix_chap5_ppi_core_full.tex}

\input{generated_tables/appendix_chap5_confusion_full.tex}
