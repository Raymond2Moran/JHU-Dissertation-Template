...
\chaptersummary{With the surrogate fixed, the application chapter has three jobs: evaluate predictive performance, use the same predictions for corrected inference, and study how sample-size planning changes under both i.i.d. and dependence-sensitive assumptions. The main empirical result is that the surrogate supports stable prediction-powered estimates, while the size of the planning gains remains sensitive to how dependence across edges is handled.}
